...
const features = [
  {
    ...
    description:
      'Smart contract escrow ensures trainers get paid and clients get refunds if sessions are cancelled.',
  },
  {
    icon: Zap,
    title: 'Instant Settlement',
    description:
      'Built on Avalanche for sub-second transaction finality and minimal fees.',
  },
  {
    icon: Star,
    title: 'Verified Reviews',
    description:
      'On-chain ratings that cannot be faked or manipulated. Real feedback from real sessions.',
  },
  {
    icon: Globe,
    title: 'Kenya-First',
    description:
      'Designed for the East African fitness market with local trainers and convenient scheduling.',
  },
];
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-primary-foreground/70 mb-10 max-w-2xl mx-auto leading-relaxed">
              The decentralized marketplace connecting you with certified fitness
              professionals. Transparent payments, verified reviews, and trustless
              bookings powered by blockchain.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Combining the power of blockchain with fitness to create a
              transparent, trustworthy marketplace.
            </p>
          </motion.div>
      ...
      <section className="py-20 lg:py-32 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Simple, secure, and transparent fitness booking in 4 steps.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: 'Link your MetaMask or Core Wallet to get started.',
              },
              {
                step: '02',
                title: 'Find a Trainer',
                description:
                  'Browse verified trainers by specialty, location, and ratings.',
              },
              {
                step: '03',
                title: 'Book & Pay',
                description:
                  'Select a time slot and pay with AVAX. Funds held in escrow.',
              },
              {
                step: '04',
                title: 'Train & Review',
                description:
                  'Complete your session and leave an on-chain review.',
              },
            ].map((item, i) => (
              <motion.div
                key={item.step}
