      ...
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="verified" className="font-medium">Verified Only</Label>
          </div>
          <Switch id="verified" checked={verifiedOnly} onCheckedChange={onVerifiedOnlyChange} />
        </div>

        <div className="space-y-3">
          <Label className="font-medium">Price Range (USDC/hr)</Label>
          <Slider
            value={[priceRange[1]]}
        ...
        {(selectedSpecialties.length > 0 || verifiedOnly || priceRange[1] < 300) && (
          <button
            onClick={() => {
              onSpecialtiesChange([]);
