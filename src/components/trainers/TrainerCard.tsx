...
import { Star, MapPin, CheckCircle, Dumbbell, Users, Video, Globe } from 'lucide-react';
    ...
    <Card className="group h-full gradient-card border-border/50 hover:shadow-medium hover:border-primary/20 transition-all duration-300">
      <CardContent className="p-6">
        ...
        <div className="flex flex-wrap gap-1.5 mb-4">
          ...
          {trainer.specialties.length > 3 && <Badge variant="outline" className="text-xs font-normal">+{trainer.specialties.length - 3}</Badge>}
        </div>
        ...
        <div className="pt-4 border-t border-border/50 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col p-2 rounded-lg bg-muted/30">
              ...
              <span className="font-display font-bold text-sm">{trainer.physicalRate.toFixed(0)} USDC</span>
            ...
            <div className="flex flex-col p-2 rounded-lg bg-muted/30">
              ...
              <span className="font-display font-bold text-sm">{trainer.virtualRate.toFixed(0)} USDC</span>
